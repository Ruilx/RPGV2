...
#define ChoiseBuff 3 // 默认一页显示几个选项
/**
...
//	QGraphicsTextItem *messages[ChoiseBuff] = {nullptr};
...
//		if(index > this->messageList.length() - ChoiseBuff){
...
//		if(index < 0 || index >= ChoiseBuff){
//			qDebug() << CodePath() << ": index is out of range: " << index << "</>[0," << ChoiseBuff << "]";
//		}
