#include "RpgDialogBase_Old.h"

int RpgDialogBase_Old::getDialogHeight() const{
	return dialogHeight;
}

void RpgDialogBase_Old::setDialogHeight(int height){
	dialogHeight = height;
	this->rect = QRect(marginH, ScreenHeight - marginV - dialogHeight, ScreenWidth - marginH - marginH, dialogHeight);
}

void RpgDialogBase_Old::setMargin(int h, int v){
	this->marginH = h;
	this->marginV = v;
	this->rect = QRect(marginH, ScreenHeight - marginV - dialogHeight, ScreenWidth - marginH - marginH, dialogHeight);
}

int RpgDialogBase_Old::getMarginH() const {
	return this->marginH;
}

int RpgDialogBase_Old::getMarginV() const {
	return this->marginV;
}

void RpgDialogBase_Old::setPadding(int h, int v){
	this->paddingH = h;
	this->paddingV = v;
	this->selectBarScaleRect = QRect(paddingH, paddingV, ScreenWidth - marginH - marginH - paddingH - paddingH, selectBarHeight);
}

int RpgDialogBase_Old::getPaddingH() const{
	return this->paddingH;
}

int RpgDialogBase_Old::getPaddingV() const{
	return this->paddingV;
}

QImage &RpgDialogBase_Old::getDialogImage(){
	return this->renderedDialogImage;
}

QImage &RpgDialogBase_Old::getSelectBarImage()
{
	return this->renderedSelectBarImage;
}

QImage *RpgDialogBase_Old::getContinueSymbol(int index) const{
	if(index < 0 || index >= 4){
		return nullptr;
	}
...
void RpgDialogBase_Old::renderSkin(const QString &skinFilename){
...
void RpgDialogBase_Old::renderBackground(){
...
void RpgDialogBase_Old::renderDialog(){
...
RpgDialogBase_Old::RpgDialogBase_Old(const QString &skinFilename){
	QString skin;
...
void RpgDialogBase_Old::setDialogSkinFilename(const QString &filename){
	this->renderSkin(filename);
}

void RpgDialogBase_Old::setDialogRect(const QRect &rect){
	if(rect.isNull()){
		this->rect = QRect(marginH, ScreenHeight - marginV - dialogHeight, ScreenWidth - marginH - marginH, dialogHeight);
	}else{
		this->rect = rect;
...
void RpgDialogBase_Old::setSelectBarRect(const QRect &rect){
	if(rect.isNull()){
		this->selectBarScaleRect = QRect(paddingH, paddingV, ScreenWidth - marginH - marginH - paddingH - paddingH, selectBarHeight);
	}else{
